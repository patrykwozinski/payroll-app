 ...
 */
final class Version20200807070214 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE payroll_record (id UUID NOT NULL, salary_bonus DOUBLE PRECISION NOT NULL, worker_id UUID NOT NULL, salary DOUBLE PRECISION NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
